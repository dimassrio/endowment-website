module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		options: {
			...
			// SASS Settings
			sass: {
				base: 'assets/css',							// Base path to you SASS folder
				file: 'assets/css/main.scss',							// SASS file (ideally, one file which contains imports)
		...
		copy : {
			main:{
				files :[
				{expand:true, src:'assets/vendor/jquery.ui/ui/**', dest:'public/'},
				{expand:true, src:'assets/vendor/jquery/jquery.min.js', dest:'public/assets/js/', flatten:true, filter:'isFile'},
	...
	// Register tasks
	grunt.registerTask('default', ['clean:all', 'sass',  'concat:css', 'concat:js', 'cssmin', 'uglify', 'clean:concat', 'copy']); // Default task
